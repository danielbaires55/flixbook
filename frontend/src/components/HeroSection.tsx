    ...
    <div className="hero-section">
      <div className="hero-content">
        <div className="hero-text-content">
          <h1 className="hero-title">Clinica Benessere</h1>
          <p className="hero-description">
            La tua salute è la nostra priorità. Con la nostra nuova piattaforma
            online, puoi trovare lo specialista più adatto a te e prenotare una
            visita in pochi semplici click. Gestisci i tuoi appuntamenti in
            totale autonomia, con la professionalità e la cura che ci
            contraddistinguono.
          </p>
